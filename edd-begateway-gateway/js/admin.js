jQuery(document).ready(function ($) {
	$(document).on('click', '#begateway_capture', function (e) {
		...
		$.ajax({
			...
			type      : 'POST',
			data      : {
				action        : 'edd_begateway_gateway_capture',
				nonce         : nonce,
				order_id      : order_id
			},
			beforeSend: function () {
	...
	$(document).on('click', '#begateway_cancel', function (e) {
		...
		$.ajax({
			...
			type      : 'POST',
			data      : {
				action        : 'edd_begateway_gateway_cancel',
				nonce         : nonce,
				order_id      : order_id
			},
			beforeSend: function () {
	...
	$(document).on('click', '#begateway_refund', function (e) {
		...
		$.ajax({
			...
			type      : 'POST',
			data      : {
				action        : 'edd_begateway_gateway_refund',
				nonce         : nonce,
				order_id      : order_id,
				amount        : amount
			},
	...
	$(document).on('click', '#begateway_capture_partly', function (e) {
		...
		$.ajax({
			...
			type      : 'POST',
			data      : {
				action        : 'edd_begateway_gateway_capture_partly',
				nonce         : nonce,
				order_id      : order_id,
				amount        : amount
			},
	...
	$(document).on('click', '#begateway_refund_partly', function (e) {
		...
		$.ajax({
			...
			type      : 'POST',
			data      : {
				action        : 'edd_begateway_gateway_refund_partly',
				nonce         : nonce,
				order_id      : order_id,
				amount        : amount
			},
